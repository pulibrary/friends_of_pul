...
namespace :drupal do
  ...
  task :link_files do
    on roles(:app) do |_host|
      ...
      execute "cd #{release_path}/sites/all/themes/friends && ln -sf #{shared_path}/node_modules node_modules"
      execute "cd #{release_path}/sites/all/themes/omega && ln -sf #{shared_path}/node_modules node_modules"
